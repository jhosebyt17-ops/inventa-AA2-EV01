...
/**
 * Clase Cliente
 * Representa la entidad Cliente del sistema de ventas Inventa.
 *
 * @author Inventa Team
 * @version 1.0
 */
public class Cliente {
    ...
    public String toString() {
        return String.format(
            "Cliente [ID: %d | Nombre: %s %s | Doc: %s | Tel: %s | Correo: %s]",
            idCliente, nombre, apellido, documento, telefono, correo
        );
    }
}
